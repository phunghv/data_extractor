...
public class App {
	...
	public void extractPost() throws FacebookException, IOException {
		...
		String[] ids = { "443537385830239", "451604054903475" };
		...
		for (String id : ids) {
			try {
				ResponseList<Post> feeds = facebookClient.getFeed(id);
				TrainingDataCrawler trainingDataCrawler = new TrainingDataCrawler();
				trainingDataCrawler.initialize("data");
...
//						System.out.println(message);
						...
						trainingDataCrawler.createTrainingData("data", message);
					}
