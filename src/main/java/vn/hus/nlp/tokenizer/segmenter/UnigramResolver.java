 ...
 *         <p>
 *         This is a simple resolver for ambiguities of segmentation. It use a
 *         pre-built unigram model to resolve segmentations.
 */
public class UnigramResolver extends AbstractResolver {
	...
	private void loadUnigram(String unigramFilename) {
		...
		// load unigram model
		System.out.println("Load from file  " + unigramFilename);
